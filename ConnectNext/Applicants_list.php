...
<body>
    ...
    <div class="bgimg">
      <div class="overlay">
        <nav class="navbar navbar-expand-md navbar-dark bg-dark nav-colour">
            <div class="container">
                <a class="navbar-brand font-weight-bold" href="index-1.php" >ConnectNext</a>
  ...
  <!--  <p style="outline-style:solid ; ">
      ...
      <span></span><br>
      <h5><strong><span>Event Name: </span><span><?php echo htmlspecialchars($description_info1['Title']);?></span></strong></h5>
        <span>Crowd Limit: </span><span><?php echo htmlspecialchars($description_info1['Department']);?></span><br>
        <span>Event Type: </span><span><?php echo htmlspecialchars($description_info1['Employment_Status']);?></span><br>
        <?php 
        ...
        <span>Event Location: </span><span><?php echo htmlspecialchars($description_info1['State_Name']);?></span><br>
        <span style="float:inline-end;">Event Date: </span><span><?php $until_date = date("d-m-Y", strtotime($description_info1['Until'])); echo htmlspecialchars($until_date);?></span>
          <?php } ?>
