...
<body>
    <main>
      ...
      <h1 style="background-color: rgb(37, 175, 218); color: white;font-size: 18px;padding-left: 30px;padding-top:5px; padding-bottom:5px; display:inline-flexbox;"><i class="fa fa-location-arrow" aria-hidden="true"></i>Register for the Event?</h1>
      ...
      <form class="row g-3" style="padding-left: 25px;background-color:beige;padding-top: 20px;" action="job_apply.php" method="POST">
        ...
        <div class="col-md-6" style="padding-top: 25px;">
          ...
          <div class="col-md-10" style="padding-top:25px;">
            <label for="inputemail" class="form-label"  style="padding-right:5px">Organisation/College</label>
            <input type="text" id ="Address"  class="form-control" name="applicant_address" placeholder='Enter your institution'  ><?php echo htmlspecialchars($applicant_address);?>
        ...
        <div class="col-md-10" style="padding-top: 25px;">
          ...
          <div class="col-md-6" style="padding-top:25px;">
              <label for="inputemail" class="form-label"  style="padding-right:5px">ID Proof: (Enter google drive link)</label>
              <input type="text" class="form-control" id="inputemail" name="applicant_resume" placeholder="College ID card,adhaar card,license card.." value="<?php echo htmlspecialchars($applicant_resume);?>">
        ...
        <div class="col-md-8" style="padding-top: 25px;">
            <label for="inputposition" class="form-label"  style="padding-right:5px">Select Event:</label>
        ...
        <div class="save_cancel" style="float:right;margin-right: 10px;text-align: right;" >
           ...
           <input type="submit" name='submit' value='Confirm Registration' class="btn btn-success btn-md">
      </div>
