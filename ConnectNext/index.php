					...
					<div class="col-md-6">
						...
						<div class="card card-outline-secondary">
							<div class="card-header">
								<h3 class="mb-0"><a href="job_page1.php">User Information</a></h3>
							</div>
							<?php
							$first_name = "Erisha";
							$last_name = "Ferrao";
							$email = "erivelany@gmail.com";
							$company = "Goa College Of Engineering";
							$website = "https://drive.google.com/drive/folders/1kUiv8ncUXIkrJGXEv-3hdJKY8calzV9m";
							...
							<div class="card-body">
								<form autocomplete="off" class="form" role="form" action="index.php" method="post">
									...
									<div class="form-group row">
										<label class="col-lg-3 col-form-label form-control-label">Organisation/College</label>
										<div class="col-lg-9">
											<input class="form-control" type="text" value="<?php echo $company;?>" name="company">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-lg-3 col-form-label form-control-label">ID Proof</label>
										<div class="col-lg-9">
