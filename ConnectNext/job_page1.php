                          ...
                          <div class="collapse navbar-collapse text-center" id="navbarText">
                              <ul class="navbar-nav ml-auto">
                                  <li class="nav-item active px-1">
                                    <a class="nav-link" href="job_page1.php">Events <span class="sr-only">(current)</span></a>
                                  </li>
...
<!--Table consisting of job titles and the applications received -->
            ...
            <table class="table">
              ...
              <h1 style="background-color: rgb(37, 175, 218); color: white;font-size: 18px;padding-left: 15px;padding-top:10px;padding-bottom:15px;display:inline-flexbox;"><i class="fa fa-location-arrow" aria-hidden="true"></i>EVENT TITLE<a href="job_listing.php"><button type="button" class="btn btn-primary btn-sm" style="float: right;background-color: rgb(103, 60, 182);font-weight: bold;"><i class="fa fa-plus" aria-hidden="true"></i> CREATE AN EVENT</button></a></h1>
              <thead>
                ...
                <tr>
                  ...
                  <th scope="col">Crowd Limit</th>
                  <th scope="col">Registration Open On</th>
