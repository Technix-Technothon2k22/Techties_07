...
<div class="bgimg">
            <div class="overlay">
                <nav class="navbar navbar-expand-md navbar-dark bg-dark nav-colour">      
                  <div class="container">
                      <a class="navbar-brand font-weight-bold" href="job_page1.php" >ConnectNext</a>
                          ...
                          <div class="collapse navbar-collapse text-center" id="navbarText">
                              <ul class="navbar-nav ml-auto">
                                  <li class="nav-item active px-1">
                                    <a class="nav-link" href="job_page1.php">Events <span class="sr-only"></span></a>
                                  </li>
            ...
            <div class="col" style="border: 0.5px solid rgb(145, 141, 141);margin-right: 30px; height: auto; width: 100%;background-color: white; border-radius: 5px;">
                <div class="leftside">
                    ...
                    <h6 style="font-size: smaller;font-style: italic; color: rgb(94, 90, 90);"><?php foreach(explode(',',$applicant_details['Info_Data']) as $stages_done){echo htmlspecialchars($stages_done).'<br>'; }?></h6>
                     <h7>Event <?php echo htmlspecialchars($applicant_details['Job_Title']);?></h7>
                    
                     <h5 style="color: rgb(50, 125, 211);  margin: 0px; padding-bottom: 7px; padding-top:4px;">Organisation/College <?php echo htmlspecialchars($applicant_details['Position_Identifier']); ?></h5>        
                    ...
                    <h6 style="font-size: 15px; margin: 0px; padding-top: 9px;">ID Proof:</h6>
            ...
            <div class="col"  style="border: 0.5px solid rgb(145, 141, 141);border-radius:5px; height: 80vh; width: 90%;background-color: white;">
                <div class="rightside">
                    <div class="container" style="margin-top: 10px;">
                        ...
                        <h3 style="font-size: 18px; color: rgb(50, 125, 211);display: inline-block;">SCHEDULE</h3>
 ...
 -->
    ...
    <form  action='update_interview.php' method='POST'>
                ...
                <div class="md-form mb-3">
                    ...
                    <label class="label control-label form-label">Registration Status:</label></br>
                    <select id="inputposition" class="form-select" name="Interview_stage"> 
                        <option selected disabled>Registration Stage: <?php echo htmlspecialchars($applicant_details['Current_Status'])  ?></option>
                            <?php 
                            foreach(explode(',',$applicant_details['Application_Stages']) as $stages)
                            {
                ...
                <div class="md-form mb-3">
                            <i class="fa fa-calendar prefix grey-text" aria-hidden="true"></i>
                            <label class="label control-label">Registration Date</label>
