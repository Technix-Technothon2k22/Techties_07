...
<body>
   ...
   <p style="background-color: white;"> </p> 
      <h1 style="background-color: rgb(37, 175, 218); color: white;font-size: 18px;padding-left: 30px;padding-top:5px;display:inline-flexbox;"><i class="fa fa-location-arrow" aria-hidden="true"></i> Events Listing Details</h1>
    <!--  <p style="background-color: white;padding: 4px;"> </p> -->
      ...
      <form class="row g-3" style="padding-left: 25px;background-color:beige;padding-top: 20px;" action='Job_listing.php' method='POST'>
        <div class="col-md-10">
          <label for="inputTitle" class="form-label" >Event Name:</label>
        ...
        <div class="col-md-10">
          <label for="inputJob_Description" class="form-label" style="padding-top: 10px;">Event Description:</label>

        <!--CHANGES MADE ON 24TH FEB-10pm -->
            <input type="text" class="form-control" id="inputJob_Description" style="height:200px;font-size:14pt;" name='job_description' placeholder="Enter Event Description" value='<?php echo htmlspecialchars($job_description)?>'>
        ...
        <div class="col-md-10">
          <label for="inputAdd_appstage" class="form-label" style="padding-top: 10px;">Add Event Flow:</label><span style="font-family: monospace ;">  </span>
          <input type="text" class="form-control" id="inputAdd_appstage" style="height:100px;font-size:14pt;" name='application_stages' value='<?php echo htmlspecialchars($application_stages)?>' placeholder= " Enter Event Flow ">
        ...
        <!--CHANGES MADE ON 24TH FEB-10 pm -->
        <div class="col-md-6">
          <label for="inputPosId" class="form-label" style="padding-top: 20px;padding-right:5px">location:</label>
          <input type="text" class="form-control" id="inputPosId" name='position_identifier' placeholder="Enter Event location here" value='<?php echo htmlspecialchars($position_identifier)?>'>
          <div style="color: red; font-size: 15px;"><?php echo $errors['position_identifier']; ?></div>
        </div>

        <!--CHANGES MADE ON 25tH FEB-10 pm -->
        <div class="col-md-8" style="padding-top: 25px;">
          <label for="inputEmpStat" class="form-label"  style="padding-right:5px">Event Category:</label>
          <select id="inputEmpStat" class="form-select" name='employment_status' placeholder="Enter event category here:" value='<?php echo htmlspecialchars($employment_status)?>'>
        ...
        <div class="col-md-6" style="padding-top: 25px;">
          <label for="inputDept" class="form-label" style="padding-right:5px">Crowd capacity:</label>
          <input type="Dept" class="form-control" id="inputDept" name='department' placeholder="Enter number of people you can accomodate.." value='<?php echo htmlspecialchars($department)?>'>
        ...
        <div class="col-md-6" style="padding-top:25px;">
          ...
          <div class="input-group mb-3"  style="padding-top: 25px;padding-left: 15px;">
            <label for="pubdate" style="padding-right:5px">Registration opened on:</label>
          ...
          <div class="input-group mb-3" style="padding-top: 25px;padding-left: 15px;padding-bottom: 100px;">
            <label for="duedate" style="padding-right:5px">Event date:</label>
